...
const AddFolderButton = () => {
  ...
  return (
    <>
      ...
      >
        Add Folder
      </Tooltip>{/* Tool Tip On Add Button */}
      <Modal isOpen={modal} toggle={toggleModal}>
        <form onSubmit={handleSubmit} className="m-5 d-flex flex-column">
          ...
          <label className="mx-auto"><img src={warning} alt="" style={{maxWidth:"20px",marginRight:"10px"}}/>Folder Name Should Be Less Than 30 charectors</label>
        </form>
      </Modal>{/* Modal Containing Add Folder Form */}
    </>
  );
};
